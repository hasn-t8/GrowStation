...
if(isset($_POST['submit'])){
    ...
    $insertSQL = "INSERT INTO contact_messages (name, email, subject, message, created_at) VALUES (?, ?, ?, ?, NOW())";
...
echo smtp_mailer($_POST['mail'],$_POST['message'],$name,$subject);
function smtp_mailer($to,$msg,$name,$subject){
	...
	$mail->Subject = "Thank you for contacting GrowUp TecSolution";
	$mail->Body ="Dear <b>$name</b>,<br>
	Thank you for contacting GrowUp Tech Solution.<br>We have received your message and will reply to you as soon as possible.<br>
	<b>Best regards.</b><br>
	<b>Your Data</b><br>
	<b>Name    : </b>$name<br>
	<b>Gmail    : </b>$to<br>
...
echo "<script>
window.location.href = '/Growstation(version-1)/contact.html';
</script>";
$conn->close();
